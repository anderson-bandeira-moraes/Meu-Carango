...
class VeiculoHibridoRepository
{
    ...
    public function save(array $dados): bool
    {
        try {
            $sql = 'INSERT INTO veiculo_hibrido (
                ...
                autonomia_eletrica_pbev_km, autonomia_combinada_cidade_km,
                autonomia_combinada_estrada_km, bateria_garantia,
                ...
                autonomia_combinada_cidade_km = VALUES(autonomia_combinada_cidade_km),
                autonomia_combinada_estrada_km = VALUES(autonomia_combinada_estrada_km),
    ...
    private function prepareDados(array $dados): array
    {
        return [
            ...
            ':autonomia_combinada_cidade_km'     => $dados['autonomia_combinada_cidade_km'] ?? null,
            ':autonomia_combinada_estrada_km'    => $dados['autonomia_combinada_estrada_km'] ?? null,
