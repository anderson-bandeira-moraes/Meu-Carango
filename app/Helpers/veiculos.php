...
if (!function_exists('larguras_pneu_list')) {
    /**
     * Retorna a lista de larguras de pneu disponíveis.
     *
     * @return array Array de strings com as larguras (ex: '145', '195', '225')
     */
    function larguras_pneu_list(): array
    {
        static $list = null;

        if ($list === null) {
            $config = require CONFIG_DIR . '/veiculos.php';
            $list = $config['larguras_pneu'] ?? [];
        }
...
if (!function_exists('perfis_pneu_list')) {
    /**
     * Retorna a lista de perfis de pneu disponíveis (série + construção radial).
     *
     * @return array Array de strings com os perfis (ex: '60R', '70R', '80R')
     */
    function perfis_pneu_list(): array
    {
        static $list = null;

        if ($list === null) {
            $config = require CONFIG_DIR . '/veiculos.php';
            $list = $config['perfis_pneu'] ?? [];
        }
...
if (!function_exists('aros_pneu_list')) {
    /**
     * Retorna a lista de aros de pneu disponíveis (em polegadas).
     *
     * @return array Array de strings com os aros (ex: '14', '15', '16', '17')
     */
...
if (!function_exists('indices_carga_pneu_list')) {
    /**
     * Retorna a lista de índices de carga de pneu disponíveis.
     *
     * @return array Array de strings com os índices de carga (ex: '88', '91', '94', '97')
     */
    function indices_carga_pneu_list(): array
    {
        static $list = null;

        if ($list === null) {
            $config = require CONFIG_DIR . '/veiculos.php';
            $list = $config['indices_carga_pneu'] ?? [];
        }
...
if (!function_exists('simbolos_velocidade_pneu_list')) {
    /**
     * Retorna a lista de símbolos de velocidade de pneu disponíveis.
     *
     * @return array Array de strings com os símbolos (ex: 'T', 'H', 'V', 'ZR')
     */
    function simbolos_velocidade_pneu_list(): array
    {
        static $list = null;

        if ($list === null) {
            $config = require CONFIG_DIR . '/veiculos.php';
            $list = $config['simbolos_velocidade_pneu'] ?? [];
        }
