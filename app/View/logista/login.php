    ...
    <div class="col-md-6 col-lg-5">
        <div class="card shadow-lg border-0 rounded-4">
            <div class="card-header bg-dark text-white text-center rounded-top-4">
                <h4 class="mb-0"><i class="bi bi-shield-lock-fill me-2"></i>Acesso Lojista</h4>
            </div>
            <div class="card-body p-4">
                ...
                <form id="loginForm" method="POST" action="/logista/login">
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <p>Como deseja testar o login?</p>
        ...
        function handleAjaxLogin() {
            ...
            .then(({ status, data }) => {
                ...
                if (status === 200 && data.sucesso) {
                    ...
                    window.location.href = data.redirect || '/logista/dashboard';
                } else if (status === 403) {
                    // Token inválido (CSRF)
