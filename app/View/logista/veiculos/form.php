...
<div class="container-fluid px-4">
    ...
    <!-- ========== FORMULÁRIO ========== -->
    <form id="veiculoForm" action="<?= $isEdit ? "/logista/veiculos/atualizar/{$veiculo['id']}" : '/logista/veiculos/salvar' ?>" method="POST" enctype="multipart/form-data" novalidate class="needs-validation">
            ...
            <div class="card-body">
                <div class="row g-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <input title="Digite o ano com 4 dígitos" placeholder="Ex: 2025" type="text" inputmode="numeric" pattern="\d*" data-tipo="inteiro" maxlength="4" name="ano_fabricacao" id="ano_fabricacao" class="form-control <?= isset($errors['ano_fabricacao']) ? 'is-invalid' : '' ?>" 
                        ...
                        <div class="col-12 flex-fields" style="display: none;">
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <div class="input-group has-validation">
                                        <input type="text" inputmode="numeric" pattern="\d*" data-tipo="inteiro" name="potencia_etanol_cv" id="potencia_etanol_cv" 
                ...
                <div class="card-body">
                    <div class="row g-3">
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="input-group has-validation">
                                <input type="text" inputmode="numeric" pattern="\d*" data-tipo="inteiro" name="potencia_max_cv" id="potencia_max_cv" 
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="input-group has-validation">
                                <input type="text" inputmode="numeric" pattern="\d*" data-tipo="inteiro" name="velocidade_max_kmh" id="velocidade_max_kmh_eletrico" 
                                       class="form-control <?= isset($errors['velocidade_max_kmh']) ? 'is-invalid' : '' ?>" 
                                       value="<?= htmlspecialchars($old['velocidade_max_kmh'] ?? $complemento['velocidade_max_kmh'] ?? '') ?>" 
                                       placeholder="Ex: 180">
                                <span class="input-group-text">km/h</span>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group has-validation">
                                <input type="text" inputmode="numeric" pattern="\d*" data-tipo="inteiro" name="autonomia_wltp_km" id="autonomia_wltp_km" 
                                       class="form-control <?= isset($errors['autonomia_wltp_km']) ? 'is-invalid' : '' ?>" 
                                       value="<?= htmlspecialchars($old['autonomia_wltp_km'] ?? $complemento['autonomia_wltp_km'] ?? '') ?>" 
                                       placeholder="Ex: 400">
                                <span class="input-group-text">km</span>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group has-validation">
                                <input type="text" inputmode="numeric" pattern="\d*" data-tipo="inteiro" name="autonomia_inmetro_km" id="autonomia_inmetro_km" 
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="input-group has-validation">
                                    <input type="text" inputmode="numeric" pattern="\d*" data-tipo="inteiro" name="tempo_carga_dc_min" id="tempo_carga_dc_min" 
            ...
            <div id="campos-hibrido" class="card shadow-sm mb-4" style="display: none;">
                ...
                <div class="card-body">
                    <div class="row g-3">
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="input-group">
                                <input type="number" step="any" inputmode="decimal" name="motor_eletrico_torque_kgfm" id="motor_eletrico_torque_kgfm" 
                                       ...
                                       value="<?= htmlspecialchars($old['motor_eletrico_torque_kgfm'] ?? $complemento['motor_eletrico_torque_kgfm'] ?? '') ?>" 
                        ...
                        <!-- ===== CARREGAMENTO (PHEV) ===== -->
                        <div id="phev-container" style="display: none;">
                            <div class="row g-3">
                                <div class="col-12">
                                    <hr>
                        ...
                        <!-- Consumo com Etanol (visível apenas para Flex) -->
                        <div id="consumo_etanol_container" style="display: none;">
                            <hr>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // =============================================
        // 6. PREPARAR SUBMISSÃO + VALIDAÇÃO FRONT-END
        // =============================================
        ...
        function aplicarRegrasHibrido(tipo) {
            ...
            if (!tipo || !CONFIG.regrasHibrido || !CONFIG.regrasHibrido[tipo]) {
                // Modo elétrico puro: exibe normalmente (sem forçar valor)
                if (modoContainer) {
            ...
            // Aplica regras para o campo "Modo Elétrico Puro"
            ...
            // Aplica regras para a seção PHEV
